...
// Generated by REAPER v4.32pre5

/*
*  Copyright 2006-2012, Cockos Incorporated
*
...
int REAPERAPI_LoadAPI(void *(*getAPI)(const char *))
{
  ...
  struct { void **dest; const char *name; } table[]={
    ...
    __RPFI(CountMediaItems) __RPFI(CountSelectedMediaItems) __RPFI(CountSelectedTracks) __RPFI(CountTakes) 
    __RPFI(CountTCPFXParms) __RPFI(CountTempoTimeSigMarkers) __RPFI(CountTrackEnvelopes) __RPFI(CountTrackMediaItems) 
    __RPFI(CountTracks) __RPFI(CreateLocalOscHandler) __RPFI(CreateMIDIInput) __RPFI(CreateMIDIOutput) 
    __RPFI(CreateNewMIDIItemInProj) __RPFI(CreateTakeAudioAccessor) __RPFI(CreateTrackAudioAccessor) __RPFI(CSurf_FlushUndo) 
    __RPFI(CSurf_GetTouchState) __RPFI(CSurf_GoEnd) __RPFI(CSurf_GoStart) __RPFI(CSurf_NumTracks) 
    __RPFI(CSurf_OnArrow) __RPFI(CSurf_OnFwd) __RPFI(CSurf_OnFXChange) __RPFI(CSurf_OnInputMonitorChange) 
    __RPFI(CSurf_OnInputMonitorChangeEx) __RPFI(CSurf_OnMuteChange) __RPFI(CSurf_OnMuteChangeEx) __RPFI(CSurf_OnOscControlMessage) 
    __RPFI(CSurf_OnPanChange) __RPFI(CSurf_OnPanChangeEx) __RPFI(CSurf_OnPause) __RPFI(CSurf_OnPlay) 
    __RPFI(CSurf_OnPlayRateChange) __RPFI(CSurf_OnRecArmChange) __RPFI(CSurf_OnRecArmChangeEx) __RPFI(CSurf_OnRecord) 
    __RPFI(CSurf_OnRecvPanChange) __RPFI(CSurf_OnRecvVolumeChange) __RPFI(CSurf_OnRew) __RPFI(CSurf_OnScroll) 
    ...
    __RPFI(DeleteExtState) __RPFI(DeleteProjectMarker) __RPFI(DeleteTrack) __RPFI(DeleteTrackMediaItem) 
    __RPFI(DestroyAudioAccessor) __RPFI(DestroyLocalOscHandler) __RPFI(Dock_UpdateDockID) __RPFI(DockIsChildOfDock) 
    __RPFI(DockWindowActivate) __RPFI(DockWindowAdd) __RPFI(DockWindowAddEx) __RPFI(DockWindowRefresh) 
    __RPFI(DockWindowRemove) __RPFI(DuplicateCustomizableMenu) __RPFI(EnsureNotCompletelyOffscreen) __RPFI(EnumPitchShiftModes) 
    __RPFI(EnumPitchShiftSubModes) __RPFI(EnumProjectMarkers) __RPFI(EnumProjectMarkers2) __RPFI(EnumProjectMarkers3) 
    __RPFI(EnumProjects) __RPFI(EnumTrackMIDIProgramNames) __RPFI(EnumTrackMIDIProgramNamesEx) __RPFI(file_exists) 
    __RPFI(format_timestr) __RPFI(format_timestr_len) __RPFI(format_timestr_pos) __RPFI(FreeHeapPtr) 
    __RPFI(genGuid) __RPFI(get_config_var) __RPFI(get_ini_file) __RPFI(get_midi_config_var) 
    __RPFI(GetActiveTake) __RPFI(GetAppVersion) __RPFI(GetAudioAccessorEndTime) __RPFI(GetAudioAccessorHash) 
    __RPFI(GetAudioAccessorSamples) __RPFI(GetAudioAccessorStartTime) __RPFI(GetColorTheme) __RPFI(GetColorThemeStruct) 
    __RPFI(GetConfigWantsDock) __RPFI(GetContextMenu) __RPFI(GetCurrentProjectInLoadSave) __RPFI(GetCursorContext) 
    ...
    __RPFI(GetItemEditingTime2) __RPFI(GetItemProjectContext) __RPFI(GetLastTouchedFX) __RPFI(GetLastTouchedTrack) 
    ...
    __RPFI(GetMIDIOutputName) __RPFI(GetMixerScroll) __RPFI(GetMouseModifier) __RPFI(GetNumMIDIInputs) 
    __RPFI(GetNumMIDIOutputs) __RPFI(GetNumTracks) __RPFI(GetOutputChannelName) __RPFI(GetOutputLatency) 
    __RPFI(GetPeakFileName) __RPFI(GetPeaksBitmap) __RPFI(GetPlayPosition) __RPFI(GetPlayPosition2) 
    __RPFI(GetPlayPosition2Ex) __RPFI(GetPlayPositionEx) __RPFI(GetPlayState) __RPFI(GetPlayStateEx) 
    __RPFI(GetProjectPath) __RPFI(GetProjectPathEx) __RPFI(GetProjectStateChangeCount) __RPFI(GetProjectTimeSignature) 
    __RPFI(GetProjectTimeSignature2) __RPFI(GetResourcePath) __RPFI(GetSelectedMediaItem) __RPFI(GetSelectedTrack) 
    __RPFI(GetSelectedTrackEnvelope) __RPFI(GetSet_ArrangeView2) __RPFI(GetSet_LoopTimeRange) __RPFI(GetSet_LoopTimeRange2) 
    __RPFI(GetSetEnvelopeState) __RPFI(GetSetEnvelopeState2) __RPFI(GetSetItemState) __RPFI(GetSetItemState2) 
    __RPFI(GetSetMediaItemInfo) __RPFI(GetSetMediaItemTakeInfo) __RPFI(GetSetMediaItemTakeInfo_String) __RPFI(GetSetMediaTrackInfo) 
    __RPFI(GetSetMediaTrackInfo_String) __RPFI(GetSetObjectState) __RPFI(GetSetObjectState2) __RPFI(GetSetRepeat) 
    __RPFI(GetSetRepeatEx) __RPFI(GetSetTrackSendInfo) __RPFI(GetSetTrackState) __RPFI(GetSetTrackState2) 
    ...
    __RPFI(GetTooltipWindow) __RPFI(GetTrack) __RPFI(GetTrackAutomationMode) __RPFI(GetTrackColor) 
    __RPFI(GetTrackEnvelope) __RPFI(GetTrackEnvelopeByName) __RPFI(GetTrackGUID) __RPFI(GetTrackInfo) 
    __RPFI(GetTrackMediaItem) __RPFI(GetTrackMIDINoteName) __RPFI(GetTrackMIDINoteNameEx) __RPFI(GetTrackNumMediaItems) 
    __RPFI(GetTrackReceiveName) __RPFI(GetTrackReceiveUIVolPan) __RPFI(GetTrackSendName) __RPFI(GetTrackSendUIVolPan) 
    __RPFI(GetTrackState) __RPFI(GetTrackUIPan) __RPFI(GetTrackUIVolPan) __RPFI(GetUserFileNameForRead) 
    __RPFI(GetUserInputs) __RPFI(GR_SelectColor) __RPFI(GSC_mainwnd) __RPFI(guidToString) 
    __RPFI(HasExtState) __RPFI(HasTrackMIDIPrograms) __RPFI(HasTrackMIDIProgramsEx) __RPFI(Help_Set) 
    __RPFI(HiresPeaksFromSource) __RPFI(InsertMedia) __RPFI(InsertMediaSection) __RPFI(InsertTrackAtIndex) 
    __RPFI(IsInRealTimeAudio) __RPFI(IsItemTakeActiveForPlayback) __RPFI(IsMediaExtension) __RPFI(IsMediaItemSelected) 
    __RPFI(IsTrackSelected) __RPFI(kbd_enumerateActions) __RPFI(kbd_formatKeyName) __RPFI(kbd_getCommandName) 
    __RPFI(kbd_getTextFromCmd) __RPFI(KBD_OnMainActionEx) __RPFI(kbd_OnMidiEvent) __RPFI(kbd_OnMidiList) 
    __RPFI(kbd_ProcessActionsMenu) __RPFI(kbd_processMidiEventActionEx) __RPFI(kbd_reprocessMenu) __RPFI(kbd_RunCommandThroughHooks) 
    __RPFI(kbd_translateAccelerator) __RPFI(kbd_translateMouse) __RPFI(LICE__Destroy) __RPFI(LICE__DestroyFont) 
    __RPFI(LICE__DrawText) __RPFI(LICE__GetBits) __RPFI(LICE__GetDC) __RPFI(LICE__GetHeight) 
    __RPFI(LICE__GetRowSpan) __RPFI(LICE__GetWidth) __RPFI(LICE__IsFlipped) __RPFI(LICE__resize) 
    __RPFI(LICE__SetBkColor) __RPFI(LICE__SetFromHFont) __RPFI(LICE__SetTextColor) __RPFI(LICE__SetTextCombineMode) 
    __RPFI(LICE_Arc) __RPFI(LICE_Blit) __RPFI(LICE_Blur) __RPFI(LICE_BorderedRect) 
    __RPFI(LICE_Circle) __RPFI(LICE_Clear) __RPFI(LICE_ClearRect) __RPFI(LICE_ClipLine) 
    __RPFI(LICE_Copy) __RPFI(LICE_CreateBitmap) __RPFI(LICE_CreateFont) __RPFI(LICE_DrawChar) 
    __RPFI(LICE_DrawGlyph) __RPFI(LICE_DrawRect) __RPFI(LICE_DrawText) __RPFI(LICE_FillCircle) 
    __RPFI(LICE_FillConvexPolygon) __RPFI(LICE_FillRect) __RPFI(LICE_FillTrapezoid) __RPFI(LICE_FillTriangle) 
    __RPFI(LICE_GetPixel) __RPFI(LICE_GradRect) __RPFI(LICE_Line) __RPFI(LICE_LineInt) 
    __RPFI(LICE_LoadPNG) __RPFI(LICE_LoadPNGFromResource) __RPFI(LICE_MeasureText) __RPFI(LICE_MultiplyAddRect) 
    __RPFI(LICE_PutPixel) __RPFI(LICE_RotatedBlit) __RPFI(LICE_RoundRect) __RPFI(LICE_ScaledBlit) 
    __RPFI(LICE_SimpleFill) __RPFI(Loop_OnArrow) __RPFI(Main_OnCommand) __RPFI(Main_OnCommandEx) 
    __RPFI(Main_openProject) __RPFI(Main_UpdateLoopInfo) __RPFI(Master_GetPlayRate) __RPFI(Master_GetPlayRateAtTime) 
    __RPFI(Master_GetTempo) __RPFI(Master_NormalizePlayRate) __RPFI(Master_NormalizeTempo) __RPFI(MB) 
    __RPFI(MIDI_eventlist_Create) __RPFI(MIDI_eventlist_Destroy) __RPFI(midi_reinit) __RPFI(MIDIEditor_GetActive) 
    __RPFI(MIDIEditor_GetMode) __RPFI(MIDIEditor_GetTake) __RPFI(MIDIEditor_LastFocused_OnCommand) __RPFI(MIDIEditor_OnCommand) 
    __RPFI(mkpanstr) __RPFI(mkvolpanstr) __RPFI(mkvolstr) __RPFI(MoveEditCursor) 
    __RPFI(MoveMediaItemToTrack) __RPFI(MuteAllTracks) __RPFI(my_getViewport) __RPFI(NamedCommandLookup) 
    __RPFI(OnPauseButton) __RPFI(OnPauseButtonEx) __RPFI(OnPlayButton) __RPFI(OnPlayButtonEx) 
    __RPFI(OnStopButton) __RPFI(OnStopButtonEx) __RPFI(OscLocalMessageToHost) __RPFI(parse_timestr) 
    __RPFI(parse_timestr_len) __RPFI(parse_timestr_pos) __RPFI(parsepanstr) __RPFI(PCM_Sink_Create) 
    __RPFI(PCM_Sink_CreateEx) __RPFI(PCM_Sink_CreateMIDIFile) __RPFI(PCM_Sink_CreateMIDIFileEx) __RPFI(PCM_Sink_Enum) 
    __RPFI(PCM_Sink_GetExtension) __RPFI(PCM_Sink_ShowConfig) __RPFI(PCM_Source_CreateFromFile) __RPFI(PCM_Source_CreateFromFileEx) 
    __RPFI(PCM_Source_CreateFromSimple) __RPFI(PCM_Source_CreateFromType) __RPFI(PeakBuild_Create) __RPFI(PeakGet_Create) 
    ...
    __RPFI(Resampler_Create) __RPFI(resolve_fn) __RPFI(screenset_register) __RPFI(screenset_registerNew) 
    __RPFI(screenset_unregister) __RPFI(screenset_unregisterByParam) __RPFI(SelectAllMediaItems) __RPFI(SelectProjectInstance) 
    ...
    __RPFI(SetRenderLastError) __RPFI(SetTempoTimeSigMarker) __RPFI(SetTrackAutomationMode) __RPFI(SetTrackColor) 
    __RPFI(SetTrackMIDINoteName) __RPFI(SetTrackMIDINoteNameEx) __RPFI(SetTrackSelected) __RPFI(ShowActionList) 
    __RPFI(ShowConsoleMsg) __RPFI(ShowMessageBox) __RPFI(SLIDER2DB) __RPFI(SnapToGrid) 
    __RPFI(SoloAllTracks) __RPFI(SplitMediaItem) __RPFI(StopPreview) __RPFI(StopTrackPreview) 
    __RPFI(StopTrackPreview2) __RPFI(stringToGuid) __RPFI(TimeMap2_beatsToTime) __RPFI(TimeMap2_GetDividedBpmAtTime) 
    ...
    __RPFI(Track_GetPeakHoldDB) __RPFI(Track_GetPeakInfo) __RPFI(TrackFX_FormatParamValue) __RPFI(TrackFX_FormatParamValueNormalized) 
    __RPFI(TrackFX_GetByName) __RPFI(TrackFX_GetChainVisible) __RPFI(TrackFX_GetCount) __RPFI(TrackFX_GetEnabled) 
    __RPFI(TrackFX_GetEQ) __RPFI(TrackFX_GetEQBandEnabled) __RPFI(TrackFX_GetEQParam) __RPFI(TrackFX_GetFloatingWindow) 
    __RPFI(TrackFX_GetFormattedParamValue) __RPFI(TrackFX_GetFXGUID) __RPFI(TrackFX_GetFXName) __RPFI(TrackFX_GetInstrument) 
    __RPFI(TrackFX_GetNumParams) __RPFI(TrackFX_GetOpen) __RPFI(TrackFX_GetParam) __RPFI(TrackFX_GetParamEx) 
    __RPFI(TrackFX_GetParamName) __RPFI(TrackFX_GetParamNormalized) __RPFI(TrackFX_GetPreset) __RPFI(TrackFX_NavigatePresets) 
    __RPFI(TrackFX_SetEnabled) __RPFI(TrackFX_SetEQBandEnabled) __RPFI(TrackFX_SetEQParam) __RPFI(TrackFX_SetOpen) 
    __RPFI(TrackFX_SetParam) __RPFI(TrackFX_SetParamNormalized) __RPFI(TrackFX_SetPreset) __RPFI(TrackFX_Show) 
    __RPFI(TrackList_AdjustWindows) __RPFI(TrackList_UpdateAllExternalSurfaces) __RPFI(Undo_BeginBlock) __RPFI(Undo_BeginBlock2) 
    __RPFI(Undo_CanRedo2) __RPFI(Undo_CanUndo2) __RPFI(Undo_DoRedo2) __RPFI(Undo_DoUndo2) 
    __RPFI(Undo_EndBlock) __RPFI(Undo_EndBlock2) __RPFI(Undo_OnStateChange) __RPFI(Undo_OnStateChange2) 
    __RPFI(Undo_OnStateChange_Item) __RPFI(Undo_OnStateChangeEx) __RPFI(Undo_OnStateChangeEx2) __RPFI(UpdateArrange) 
    __RPFI(UpdateItemInProject) __RPFI(UpdateTimeline) __RPFI(ValidatePtr) __RPFI(ViewPrefs) 
    __RPFI(WDL_VirtualWnd_ScaledBlitBG) 
  };
  int i,failcnt=0;
